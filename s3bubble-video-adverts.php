<?php
/*
Plugin Name: S3Bubble Depreciated
Plugin URI: https://www.s3bubble.com/
Description: Depreciated this version is no longer supported please use main plugin 
Version: 0.8
Author: S3Bubble
...
if (!class_exists("s3bubble_video_adverts")) {
	class s3bubble_video_adverts {
		...
		*/ 
		...
		?>
		<div class="wrap">
			<h1>Depreciated this version is no longer supported please use main plugin </h1>
